...
>
  ...
  {#each items as it (it.value)}
    ...
    <button
      ...
      class="relative z-10 inline-flex min-w-[3rem] flex-1 cursor-pointer items-center justify-center gap-1.5 rounded px-3 py-1 transition-colors select-none {active
        ? 'font-medium'
